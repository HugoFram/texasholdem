...
ALTER TABLE `player` ADD `wants_confirmactions` BOOLEAN DEFAULT false;
ALTER TABLE `player` ADD `wants_autocheck` BOOLEAN DEFAULT false;
ALTER TABLE `player` ADD `wants_autocall` BOOLEAN DEFAULT false;
